...
### 5.4 Narrative Player (`/narrative/:context`)

**Purpose:** Walk through a story step by step.
...
├─────────────────────────────────┤
│                                 │
│  📖 February 2026 Rally         │  ← narrative title
│  9 steps                        │
│                                 │
│  ┌─ Step 1 ───────────────────┐ │
│  │                             │ │
│  │ US Announces 25% Tariffs   │ │  ← from entity
│  │         │                   │ │
│  │     causes                  │ │  ← relation type
│  │         ↓                   │ │
│  │ Bitcoin Drops to $95K      │ │  ← to entity
│  │                             │ │
│  │ "Tariff announcement       │ │  ← relation description
│  │  triggers risk-off..."     │ │
│  └─────────────────────────────┘ │
│                                 │
│  ┌─ Step 2 ───────────────────┐ │
...
│                                 │
│  ── Timeline ──────────────────  │
│  Jan 29 ●──●──────●────●──● Feb│  ← horizontal timeline dots
│  Fed    ECB Tariff  BTC Gold CPI│
│                                 │
└─────────────────────────────────┘
```

**Data source:** `GET /api/narratives/:context`

**Features:**
- Steps rendered as vertical chain cards
- Entities within steps are tappable → Entity Detail View
- Optional compact timeline bar at the bottom with dots positioned by temporal data
- Tap a timeline dot → scroll to that step
...
#/narrative/:context        → Narrative Player
