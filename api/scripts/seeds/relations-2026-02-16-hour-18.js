/**
 * NOESIS Seed: Auto-generated Relations (2026-02-16 18:00)
 * Namespace: relations
 * Built by seed-factory on 2026-02-16
 * 100 relations inferred by connect job
 * Entities: 0 | Relations: 100 | Sources: 0
 */
module.exports = async function seed_relations_2026_02_16_hour_18(client) {
  console.log('  \u2192 Seeding: relations-2026-02-16-hour-18');
  ...
  await client.query(`
    ...
    ('okx-snags-european-payments-license-for-2026-02-16', 'from-wall-street-to-web3-this-is-crypto-2026-02-16', 'co_occurrence', 0, 'Shared: crypto', '{"shared_entities":["crypto"],"source":"connect_job"}'::jsonb),
    ...
    ('okx-snags-european-payments-license-for-2026-02-16', 'un-staffers-back-francesca-albanese-con-2026-02-16', 'co_occurrence', 0, 'Shared: eu, european', '{"shared_entities":["eu","european"],"source":"connect_job"}'::jsonb),
    ...
    ('okx-snags-european-payments-license-for-2026-02-16', 'crypto-mining-can-help-energy-volatility-2026-02-16', 'co_occurrence', 0, 'Shared: crypto', '{"shared_entities":["crypto"],"source":"connect_job"}'::jsonb),
    ...
    ('okx-snags-european-payments-license-for-2026-02-16', 'europe-s-israel-policy-faces-a-democrati-2026-02-16', 'co_occurrence', 0, 'Shared: eu', '{"shared_entities":["eu"],"source":"connect_job"}'::jsonb),
    ('okx-snags-european-payments-license-for-2026-02-16', 'chevron-led-joint-venture-signs-major-ga-2026-02-16', 'co_occurrence', 0, 'Shared: eu, european', '{"shared_entities":["eu","european"],"source":"connect_job"}'::jsonb),
    ('okx-snags-european-payments-license-for-2026-02-16', 'real-madrid-play-benfica-in-champions-le-2026-02-16', 'co_occurrence', 0, 'Shared: eu', '{"shared_entities":["eu"],"source":"connect_job"}'::jsonb),
    ('okx-snags-european-payments-license-for-2026-02-16', 'the-seeds-of-the-dramatic-selloff-in-ai-2026-02-16', 'co_occurrence', 0, 'Shared: eu', '{"shared_entities":["eu"],"source":"connect_job"}'::jsonb),
    ...
    ('blackrocks-digital-assets-head-leverag-2026-02-15', 'bitcoin-could-fall-to-10-000-as-u-s-re-2026-02-16', 'co_occurrence', 0, 'Shared: bitcoin', '{"shared_entities":["bitcoin"],"source":"connect_job"}'::jsonb),
    ...
    ('blackrocks-digital-assets-head-leverag-2026-02-15', 'harvard-cuts-bitcoin-exposure-by-20-ad-2026-02-16', 'co_occurrence', 0, 'Shared: bitcoin', '{"shared_entities":["bitcoin"],"source":"connect_job"}'::jsonb),
    ...
    ('blackrocks-digital-assets-head-leverag-2026-02-15', 'from-wall-street-to-web3-this-is-crypto-2026-02-16', 'co_occurrence', 0, 'Shared: crypto', '{"shared_entities":["crypto"],"source":"connect_job"}'::jsonb),
    ...
    ('blackrocks-digital-assets-head-leverag-2026-02-15', 'crypto-mining-can-help-energy-volatility-2026-02-16', 'co_occurrence', 0, 'Shared: crypto', '{"shared_entities":["crypto"],"source":"connect_job"}'::jsonb),
    ...
    ('eleven-killed-in-israeli-strikes-on-gaza-2026-02-15', 'israel-to-restart-land-registration-in-w-2026-02-16', 'co_occurrence', 0, 'Shared: israel, israeli', '{"shared_entities":["israel","israeli"],"source":"connect_job"}'::jsonb),
    ...
    ('eleven-killed-in-israeli-strikes-on-gaza-2026-02-15', 'un-staffers-back-francesca-albanese-con-2026-02-16', 'co_occurrence', 0, 'Shared: israel, gaza', '{"shared_entities":["israel","gaza"],"source":"connect_job"}'::jsonb),
    ...
    ('eleven-killed-in-israeli-strikes-on-gaza-2026-02-15', 'europe-s-israel-policy-faces-a-democrati-2026-02-16', 'co_occurrence', 0, 'Shared: israel', '{"shared_entities":["israel"],"source":"connect_job"}'::jsonb),
    ('eleven-killed-in-israeli-strikes-on-gaza-2026-02-15', 'shipping-industry-set-to-consolidate-as-2026-02-16', 'co_occurrence', 0, 'Shared: israel, israeli', '{"shared_entities":["israel","israeli"],"source":"connect_job"}'::jsonb),
    ('eleven-killed-in-israeli-strikes-on-gaza-2026-02-15', 'how-shipping-company-msc-facilitates-tra-2026-02-16', 'co_occurrence', 0, 'Shared: israel, israeli', '{"shared_entities":["israel","israeli"],"source":"connect_job"}'::jsonb),
  ...
  console.log('  \u2713 relations-2026-02-16-hour-18: 0 entities, 100 relations, 0 sources');
};
