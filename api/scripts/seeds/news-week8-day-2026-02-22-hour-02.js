/**
 * NOESIS Seed: Daily News — 2026-02-22 02:00 (Week 8, 2026)
 * Namespace: news.week8.day-2026-02-22
 * Built by seed-factory on 2026-02-22
 * Auto-gathered news: 2 stories, 2026-02-22 to 2026-02-22
 * Entities: 2 | Relations: 0 | Sources: 2
 */
module.exports = async function seed_news_week8_day_2026_02_22_hour_02(client) {
  console.log('  \u2192 Seeding: news-week8-day-2026-02-22-hour-02');
  ...
  await client.query(`
    ...
    ('pakistan-carries-out-strikes-in-afghanis-2026-02-22', 'news.week8.day-2026-02-22', 'Event', 'Pakistan carries out strikes in Afghanistan after Islamabad suicide attack', NULL, '{"category":"geopolitics","description":"Afghan sources say the Pakistani strikes hit the border provinces of Paktika and Nangarhar."}'::jsonb, '{"timestamp":"2026-02-22T01:04:28.000Z","precision":"day"}'::jsonb, '{"confidence":"high","sources_count":1}'::jsonb),
  ...
  console.log('  \u2713 news-week8-day-2026-02-22-hour-02: 2 entities, 0 relations, 2 sources');
};
