/**
 * NOESIS Seed: Daily News — 2026-02-25 03:00 (Week 9, 2026)
 * Namespace: news.week9.day-2026-02-25
 * Built by seed-factory on 2026-02-25
 * Auto-gathered news: 16 stories, 2026-02-25 to 2026-02-25
 * Entities: 16 | Relations: 1 | Sources: 16
 * Narratives: Energy Markets
 */
module.exports = async function seed_news_week9_day_2026_02_25_hour_03(client) {
  console.log('  \u2192 Seeding: news-week9-day-2026-02-25-hour-03');
  ...
  await client.query(`
    ...
    ('aid-groups-petition-israeli-supreme-cour-2026-02-25', 'news.week9.day-2026-02-25', 'Event', 'Aid groups petition Israeli Supreme Court as Gaza, West Bank work ban nears', NULL, '{"category":"geopolitics","description":"Israel has ordered 37 aid groups to halt operations in war-torn Gaza, as well as occupied West Bank and East Jerusalem."}'::jsonb, '{"timestamp":"2026-02-25T02:15:14.000Z","precision":"day"}'::jsonb, '{"confidence":"high","sources_count":1}'::jsonb),
    ('bolivia-revives-anti-drug-alliance-after-2026-02-25', 'news.week9.day-2026-02-25', 'Event', 'Bolivia revives anti-drug alliance after nearly 18-year break with US', NULL, '{"category":"geopolitics","description":"Bolivian President Rodrigo Paz has moved to restore diplomatic ties with the US and cooperate with the DEA."}'::jsonb, '{"timestamp":"2026-02-25T01:46:23.000Z","precision":"day"}'::jsonb, '{"confidence":"high","sources_count":1}'::jsonb),
    ...
    ('india-8217-s-ai-boom-pushes-firms-to-tr-2026-02-25', 'news.week9.day-2026-02-25', 'Event', 'India''s AI boom pushes firms to trade near-term revenue for users', NULL, '{"category":"technology.ai","description":"ChatGPT and rivals are testing whether India''s massive AI user boom can translate into paying customers as free offers wind down."}'::jsonb, '{"timestamp":"2026-02-25T02:00:00.000Z","precision":"day"}'::jsonb, '{"confidence":"medium","sources_count":1}'::jsonb),
    ...
    ('boozy-chimps-fail-urine-test-confirm-ho-2026-02-25', 'news.week9.day-2026-02-25', 'Event', 'Boozy chimps fail urine test, confirm hotly debated theory', NULL, '{"category":"technology","description":"Boozy chimps fail urine test, confirm hotly debated theory"}'::jsonb, '{"timestamp":"2026-02-25T00:05:05.000Z","precision":"day"}'::jsonb, '{"confidence":"high","sources_count":1}'::jsonb)
  ...
  await client.query(`
    ...
    ('aid-groups-petition-israeli-supreme-cour-2026-02-25', 'article', 'Aid groups petition Israeli Supreme Court as Gaza, West Bank work ban nears', 'https://www.aljazeera.com/news/2026/2/25/aid-groups-petition-israeli-supreme-court-as-gaza-west-bank-work-ban-nears', 'Israel has ordered 37 aid groups to halt operations in war-torn Gaza, as well as occupied West Bank and East Jerusalem.', 'Al Jazeera', '2026-02-25T02:15:14.000Z'),
    ('bolivia-revives-anti-drug-alliance-after-2026-02-25', 'article', 'Bolivia revives anti-drug alliance after nearly 18-year break with US', 'https://www.aljazeera.com/news/2026/2/25/bolivia-revives-anti-drug-alliance-after-nearly-18-year-break-with-us', 'Bolivian President Rodrigo Paz has moved to restore diplomatic ties with the US and cooperate with the DEA.', 'Al Jazeera', '2026-02-25T01:46:23.000Z'),
    ...
    ('india-8217-s-ai-boom-pushes-firms-to-tr-2026-02-25', 'article', 'India''s AI boom pushes firms to trade near-term revenue for users', 'https://techcrunch.com/2026/02/24/india-ai-boom-pushes-firms-to-trade-near-term-revenue-for-users/', 'ChatGPT and rivals are testing whether India''s massive AI user boom can translate into paying customers as free offers wind down.', 'TechCrunch', '2026-02-25T02:00:00.000Z'),
    ...
    ('boozy-chimps-fail-urine-test-confirm-ho-2026-02-25', 'article', 'Boozy chimps fail urine test, confirm hotly debated theory', 'https://arstechnica.com/science/2026/02/boozy-chimps-fail-urine-test-confirm-hotly-debated-theory/', NULL, 'Ars Technica', '2026-02-25T00:05:05.000Z')
    ON CONFLICT DO NOTHING
  `);
  console.log('    Sources: 16');

  console.log('  \u2713 news-week9-day-2026-02-25-hour-03: 16 entities, 1 relations, 16 sources');
};
