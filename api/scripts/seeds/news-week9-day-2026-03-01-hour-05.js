/**
 * NOESIS Seed: Daily News — 2026-03-01 05:00 (Week 9, 2026)
 ...
 */
module.exports = async function seed_news_week9_day_2026_03_01_hour_05(client) {
  console.log('  \u2192 Seeding: news-week9-day-2026-03-01-hour-05');
  ...
  await client.query(`
    ...
    ('hundreds-of-thousands-of-travellers-stra-2026-03-01', 'news.week9.day-2026-03-01', 'Event', 'Hundreds of thousands of travellers stranded or diverted amid air space closures in Middle East', NULL, '{"category":"finance","description":"<p>Chaos as key transit hubs in Dubai, Abu Dhabi and Doha close, and more than 1,000 flights by major Middle Eastern airlines cancelled</p><ul><li><p><a href=\\"https://www.theguardian.com/us-news/2026/feb/28/khamenei-likely-killed-us-israel-iran-strikes\\">Full report: Iran state media confirms killing"}'::jsonb, '{"timestamp":"2026-03-01T00:09:27.000Z","precision":"day"}'::jsonb, '{"confidence":"high","sources_count":1}'::jsonb),
    ...
    ('iran-war-becomes-50-million-betting-fre-2026-03-01', 'news.week9.day-2026-03-01', 'Event', 'Iran war becomes $50 million betting frenzy on Polymarket', NULL, '{"category":"finance.crypto","description":"The prediction market has spun up over a dozen Iran-related contracts since Saturday''s strikes, with the Khamenei removal market alone pulling in $45 million in volume."}'::jsonb, '{"timestamp":"2026-03-01T04:19:51.000Z","precision":"day"}'::jsonb, '{"confidence":"high","sources_count":1}'::jsonb),
  ...
  await client.query(`
    ...
    ('iran-war-becomes-50-million-betting-fre-2026-03-01', 'article', 'Iran war becomes $50 million betting frenzy on Polymarket', 'https://www.coindesk.com/markets/2026/03/01/iran-war-becomes-usd50-million-betting-frenzy-on-polymarket', 'The prediction market has spun up over a dozen Iran-related contracts since Saturday''s strikes, with the Khamenei removal market alone pulling in $45 million in volume.', 'CoinDesk', '2026-03-01T04:19:51.000Z'),
  ...
  console.log('  \u2713 news-week9-day-2026-03-01-hour-05: 13 entities, 0 relations, 13 sources');
};
