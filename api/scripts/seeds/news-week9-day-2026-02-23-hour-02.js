/**
 * NOESIS Seed: Daily News — 2026-02-23 02:00 (Week 9, 2026)
 * Namespace: news.week9.day-2026-02-23
 * Built by seed-factory on 2026-02-23
 * Auto-gathered news: 7 stories, 2026-02-23 to 2026-02-23
 * Entities: 7 | Relations: 0 | Sources: 7
 */
module.exports = async function seed_news_week9_day_2026_02_23_hour_02(client) {
  console.log('  \u2192 Seeding: news-week9-day-2026-02-23-hour-02');
  ...
  await client.query(`
    ...
    ('u-s-stock-futures-drop-as-investors-awa-2026-02-23', 'news.week9.day-2026-02-23', 'Event', 'U.S. stock futures drop as investors await clarity on Trump&#x2019;s latest tariff plans', NULL, '{"category":"finance.markets","description":"U.S. stock-market futures declined Sunday, as investors grappled with the implications of Friday&#x2019;s Supreme Court ruling that overturned most of President Donald Trump&#x2019;s tariffs."}'::jsonb, '{"timestamp":"2026-02-23T01:08:00.000Z","precision":"day"}'::jsonb, '{"confidence":"high","sources_count":1}'::jsonb),
  ...
  console.log('  \u2713 news-week9-day-2026-02-23-hour-02: 7 entities, 0 relations, 7 sources');
};
